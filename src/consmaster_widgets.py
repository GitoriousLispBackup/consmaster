...
class WidgetLayout(QWidget) :
    ...
    def createWidgets(self) :
        ...
        tb.addAction(QIcon("../icons/cons.png"), "Validate")
        tb.addAction(QIcon("../icons/cons.png"), "Add")
        tb.addAction(QIcon("../icons/cons.png"), "Remove", glispEntry.removeCons)
        tb.addAction(QIcon("../icons/cons.png"), "CleanALl")
